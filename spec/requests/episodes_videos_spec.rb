...
RSpec.describe "Episode Videos", type: :request do
  ...
  describe "GET /shows/:show_id/seasons/:season_id/episodes/:id/videos" do
    context "when user is not signed in" do
      it "redirects to the user sign in page" do
        get show_season_episode_videos_path(episode, season_id: season, show_id: season.show)
  ...
  describe "POST /shows/:show_id/seasons/:season_id/episodes/:id/videos" do
    context "when user is not signed in" do
      it "redirects to the user sign in page" do
    ...
    context "when user is signed in" do
      ...
      context "with valid params" do
        ...
        it "redirects to the videos index path" do
          post show_season_episode_videos_path(episode, season_id: season, show_id: season.show), params: {video: valid_attributes}
          expect(response).to redirect_to show_season_episode_videos_path(episode, season_id: season, show_id: season.show)
        end
      end

      context "with invalid params" do
        it "does not create an video" do
          post show_season_episode_videos_path(episode, season_id: season, show_id: season.show), params: {video: invalid_attributes}
  ...
  describe "DELETE /shows/:show_id/seasons/:season_id/episodes/:episode_id/videos/:id" do
    context "when user is not signed in" do
      it "redirects to the user sign in page" do
        video = episode.videos.create!(valid_attributes)
        delete show_season_episode_video_path(video, episode_id: episode, season_id: season, show_id: season.show)
        expect(response).to redirect_to new_session_path
      end
    end
