...
RSpec.describe "Show Galleries", type: :request do
  describe "GET /show/:id/galleries/posters" do
  ...
  describe "GET /show/:id/galleries/logos" do
  ...
  describe "GET /show/:id/galleries/backgrounds" do
  ...
  describe "GET /show/:id/galleries/videos" do
