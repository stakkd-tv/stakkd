...
RSpec.describe EpisodesController, type: :routing do
  describe "routing" do
    ...
    it "routes to #add_to_history" do
      expect(post: "/shows/1/seasons/1/episodes/1/add_to_history").to route_to("episodes#add_to_history", id: "1", season_id: "1", show_id: "1")
    end

    it "routes to #add_to_stack" do
      expect(post: "/shows/1/seasons/1/episodes/1/add_to_stack").to route_to("episodes#add_to_stack", id: "1", season_id: "1", show_id: "1")
    end

    it "routes to #create_and_add_to_stack" do
      expect(post: "/shows/1/seasons/1/episodes/1/create_and_add_to_stack").to route_to("episodes#create_and_add_to_stack", id: "1", season_id: "1", show_id: "1")
    end

    it "routes to #remove_from_history" do
      expect(delete: "/shows/1/seasons/1/episodes/1/remove_from_history").to route_to("episodes#remove_from_history", id: "1", season_id: "1", show_id: "1")
    end
