...
RSpec.feature "Movie form", type: :system, js: true do
  ...
  scenario "Using the movie form", :ignore_form_failures do
    ...
    using_wait_time 5 do
      ...
      expect(movie.reload.cast_members.count).to eq 1
    end
    ...
    using_wait_time 5 do
      ...
      expect(movie.reload.cast_members).to eq []
    end
    ...
    using_wait_time 5 do
      ...
      expect(movie.reload.crew_members.count).to eq 1
    end
    ...
    using_wait_time 5 do
      ...
      expect(movie.reload.crew_members).to eq []
    end
