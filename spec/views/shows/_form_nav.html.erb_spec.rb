...
RSpec.describe "shows/_form_nav", type: :view do
  context "when show is persisted" do
    it "renders the nav" do
      ...
      assert_select "a[href='#{show_cast_members_path(show)}'][data-active='false']"
      assert_select "a[href='#{show_crew_members_path(show)}'][data-active='false']"
      assert_select "a[href='#{show_content_ratings_path(show)}'][data-active='false']"
      ...
      assert_select "a[href='#{show_videos_path(show)}'][data-active='false']"
    end
  end
