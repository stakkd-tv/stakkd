...
RSpec.describe "movies/_form_nav", type: :view do
  context "when movie is persisted" do
    it "renders the nav" do
      ...
      assert_select "a[href='#{movie_crew_members_path(movie)}'][data-active='false']"
      ...
      assert_select "a[href='#{editor_movie_releases_path(movie)}'][data-active='false']"
      assert_select "a[href='#{movie_taglines_path(movie)}'][data-active='false']"
      assert_select "a[href='#{movie_videos_path(movie)}'][data-active='false']"
    end
  end
